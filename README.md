...
| 3 | 📊 **策略部门** | `strategy-director` | 1 | 独立分析师，一人7个策略视角 |
| 4 | 📋 **选举委员会** | `election-committee` | 1 | 投票召集人与计票人 |
| 5 | ✅ **审核部门** | `review-auditor` | 1 | 风控审计，一人5个审核视角 |
...
│   ├── strategy-director.yaml       # 策略部门 (组长一人7个策略视角)
│   ├── election-committee.yaml# 选举委员会
│   ├── review-auditor.yaml         # 审核部门 (组长一人5个审核视角)
